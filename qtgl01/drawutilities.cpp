...
void DrawUtilities::drawSquareWithTexture(const int X, const int Y, const int Z, const int L, const GLuint TID)
{
    const int HL = L/2;
    if(HL==0){
        std::cerr<<"error HL=0";
    ...
    { 1,1, 0,1, 0,0, 1,0,// v0-v1-v2-v3
      1,1, 1,0, 1,0, 1,1,// v0-v3-v4-v5
      1,1, 1,1, 0,1, 0,1,// v0-v5-v6-v1
      0,1, 0,1, 0,0, 0,0,// v1-v6-v7-v2
      0,0, 1,0, 1,0, 0,0,// v7-v4-v3-v2
      1,0, 0,0, 0,1, 1,1,// v4-v7-v6-v5
      };
